...
public class RentaController {
     ...
     * 4. Marcar Ubicación como NO disponible -> Guardar en BD
    ...
    public boolean iniciarRenta(Ubicacion ubicacion, Ticket ticket) {
        ...
        // Recargar ubicación desde BD para asegurar estado actualizado
        ...
        if (!ubicacion.isDisponible()) {
            System.err.println("La ubicación" + ubicacion + "ya esta ocupada");
            return false;
        }
        ...
        try {
            ...
            // 4. Marcar ubicación como no disponible
            ubicacion.setDisponible(false);
            ubicacionDAO.actualizar(ubicacion);
            System.out.println("Ubicación marcada como no disponible en DB: " + ubicacion);
     ...
     * 4. Liberar Ubicación -> Actualizar en BD
    ...
    public boolean finalizarRenta(Ubicacion ubicacion, Ticket ticket) {
        ...
        try {
            ...
            if (renta == null) {
                System.err.println("No hay una renta activa en ubicación " + ubicacion);
                return false;
            }
            ...
            ubicacionDAO.actualizar(ubicacion);
            System.out.println("Ubicación liberada en DB: " + ubicacion);
            
            // 5. Buscar Servicio en Ticket
            Servicio servicioRenta = getServicioRentaEnTicket(ticket, ubicacion);

            if (servicioRenta == null) {
                System.err.println("No se encontró el servicio de renta en el ticket");
                return false;
            }
